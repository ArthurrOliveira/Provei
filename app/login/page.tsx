    ...
    <div className="min-h-screen flex items-center justify-center bg-burgundy relative overflow-hidden p-4">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="bg-warm-white rounded-2xl shadow-2xl p-6 space-y-4">
          <Button
            variant="outline"
            className="w-full gap-3 border-cream-dark text-charcoal hover:bg-cream font-body font-semibold py-5"
          ...
          {sent ? (
            ...
            <form onSubmit={handleMagicLink} className="space-y-3">
              ...
              <Button
                type="submit"
                className="w-full bg-burgundy hover:bg-burgundy-light text-cream font-body font-semibold py-5"
                disabled={loading}
              >
